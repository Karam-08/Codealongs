...
// console.log(a)
// 
// a.unshift("Crimson", "Forest", "Lavender")
// console.log(a)
// 
// for(let colors of a){
//     colors +=" - Solid"
...
// 
// const middleIndex = Math.floor(music.length / 2);
// music = [...music.slice(0, middleIndex), "classic", ...music.slice(middleIndex)];
// 
// music = ["rap", "acapella", ...music];
// 
// console.log(music)
// 
// let b = ["Mordecai", "Rigby", "Benson", "Skips", "Muscle Man"]
// let c = ["Jake", "Finn", "LSP", "Marceline", "Princess Bubblegum", "Ice King"]
// 
// let e = ["BMO", ...c, "The Lich", "Flame Princess"]
// console.log(e)
// 
// let f = [...b, ...c]
// console.log(f)
// 
// let words = "Who would stop talking first? Rohan, Monte, or Justin? I'm not adding that sentence."
...
// 
// let g = newWords.join("i/er")
// console.log(g)
// 
// console.log("Hawk 1: What's 2 + 2?")
// console.log("Hawk 2: Uhh...")

let words = "Who would stop talking first? Rohan, Monte, or Justin?"
let words2 = "The real problem is always those wierd meat like people with feet and more opinions than needed."
let newWords=words.split(" ")
let newWords2=words2.split(" ")

let g = newWords.join("-")
let f = newWords2.join("-")
